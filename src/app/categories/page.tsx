    ...
    <div className="min-h-screen">
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          <h1 className="font-serif text-4xl md:text-6xl font-bold text-balance leading-tight">Shop by Category</h1>
          <p className="text-lg text-muted-foreground text-pretty leading-relaxed">
            Explore our carefully curated collections of natural skincare products, organized by your specific needs and
            preferences
          </p>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="bg-secondary rounded-3xl p-8 md:p-12 text-center space-y-6">
          <h2 className="font-serif text-3xl md:text-4xl font-bold">Not Sure Where to Start?</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Browse our complete collection or use our search to find the perfect products for your skincare routine
          </p>
